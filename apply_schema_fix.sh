...
git commit -m "fix: restore idempotency guards on triggers and policies in schema.sql"
git push origin main
echo "Done — now paste supabase/schema.sql into the Supabase SQL Editor and Run."
